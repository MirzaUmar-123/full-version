<div class="sidebar__menu-group">
    ...
    <li>
            <a href="{{ route ('showallproducts')}}">
                <i class="nav-icon la la-product-hunt"></i>
                Products
            </a>
        </li>

        <li>
            <a href="{{ route ('showallorders')}}">
                <i class="nav-icon la la-first-order"></i>
                Orders
            </a>
        </li>

        <li>
            <a href="{{ route ('showallcarts')}}">
        ...
        <li>
            <a href="{{ route ('showallcategories')}}">
                <i class="nav-icon la la-th-list"></i>
                Categories
            </a>
        </li>
        ...
        <li>
            <a href="{{ route ('showallpayments')}}">
                <i class="nav-icon la la-address-card"></i>
                Payments
            </a>
        </li>

        <li>
            <a href="{{ route ('showallshipments')}}">
                <i class="nav-icon la la-car"></i>
                Shipments
            </a>
        </li>

        <li>
            <a href="{{ route ('showallreviews')}}">
        ...
        <li>
            <a href="{{ route ('showalltransactions')}}">
                <i class="nav-icon la la-donate"></i>
                Transaction
            </a>
        </li>

        <li>
            <a href="{{ route ('showallwishlists')}}">
