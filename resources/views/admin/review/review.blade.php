                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="action-btn">
                            <a href="{{route('createreviews')}}" class="btn btn-primary">
                                <i class="las la-plus m-2"></i>Create New Review</a>
                        </div>
                    </div>
                                        ...
                                        <tr class="userDatatable-row">
                                            ...
                                            <td>
                                                <ul class="d-flex  gap-2">
                                                    ...
                                                    <li>
                                                        <a href="{{route('editreviews', ['id'=>$review->id])}}" class="btn btn-primary btn-sm" title="Edit">
                                                            <i class="uil uil-edit"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{route('deletereviews', ['id'=>$review->id])}}" class="btn btn-danger btn-sm" title="Delete"
