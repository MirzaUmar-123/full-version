        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Create New Transaction</h4>
                ...
                <form method="POST" action="#">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="paymentID" placeholder="Enter Payment ID"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="gateway" required>
                                <option value="selectgateway">Select Gateway</option>
